              ...
              <tr v-for="(theDate, index) in filteredTermine">
                ...
                <td>
                  ...
                  <div v-if="theDate.hasOwnProperty('ausschreibung')">
                    <a data-toggle="tooltip" data-placement="top" title="Ausschreibungsunterlagen" :href="'static/doc/' + theDate.ausschreibung"
                       target="ausschreibung" class="btn btn-outline-success btn-sm">
                      <i class="fa fa-file-pdf-o fa-fw"></i><span>Ausschreibung</span>
                    </a>
                  </div>
                  <div v-if="theDate.hasOwnProperty('einladung')">
                    <a data-toggle="tooltip" data-placement="top" title="Einladung" :href="'static/doc/' + theDate.einladung" target="einladung"
                       class="btn btn-outline-success btn-sm">
                      <i class="fa fa-file-pdf-o fa-fw"></i><span>Einladung</span>
                    </a>
                  </div>
                  <div v-if="theDate.hasOwnProperty('protokoll')">
                    <a data-toggle="tooltip" data-placement="top" title="Protokoll" :href="'static/doc/' + theDate.protokoll" target="prot"
                       class="btn btn-outline-success btn-sm">
