    ...
    <form id="meldungform">
      ...
      <fieldset class="form-group">
        ...
        <div class="row" :class="{'has-danger' : $v.hund_ente.$invalid}">
          <label class="col-sm-4 col-form-label">Prüfung an der lebenden Ente</label>
          <div class="col-sm-8">
            <div class="form-check form-check-inline">
              <label class="form-check-label">
      ...
      <fieldset class="form-group">
        ...
        <div class="form-group row" :class="{'has-danger' : $v.fuehrer_name.$invalid}">
          <label class="col-sm-4 col-form-label hidden-sm-down" for="namefuehrer">Name, Vorname des Hundeführer</label>
        ...
        <div class="form-group row" :class="{'has-danger' : $v.fuehrer_email.$invalid}">
          ...
          <!--
          <small v-if="$v.fuehrer_email.$invalid" class="offset-sm-4 col-sm-8 form-hint">Sie müssen eine gültige EMail angeben.</small> -->
        </div>
        <div class="row">
      ...
      <div class="row">
        <button :disabled="$v.$invalid" @click="schickeMail" type="button" class="btn btn-outline-primary text-center">Absenden</button>
      </div>
